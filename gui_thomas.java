...
public class gui_thomas extends JFrame {
	...
	private void initUI() {
		...
		encryptButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				Enkripsi_thomas window = new Enkripsi_thomas(textBox, detailsField);
		...
		decryptButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent event) {
				Dekripsi_thomas window = new Dekripsi_thomas(textBox, detailsField);
				window.setVisible(true);
			}
		});
